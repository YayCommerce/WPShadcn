<?php
/**
 * Title: Mini Cart - Large Thumbnail
 * Slug: shadcn/mini-cart-large-thumb
 * Block Types: core/template-part/mini-cart
 * Categories: shadcn, woocommerce
 * Inserter: no
 * Description: Mini-Cart drawer layout with a large product thumbnail and the details stacked beside it.
...
<!-- wp:woocommerce/mini-cart-contents {"className":"is-mini-cart-large-thumb"} -->
<div class="wp-block-woocommerce-mini-cart-contents is-mini-cart-large-thumb"><!-- wp:woocommerce/filled-mini-cart-contents-block -->
