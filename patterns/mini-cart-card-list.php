<?php
/**
 * Title: Mini Cart - Card List
 * Slug: shadcn/mini-cart-card-list
 * Block Types: core/template-part/mini-cart
 * Categories: shadcn, woocommerce
 * Inserter: no
 * Description: Mini-Cart drawer layout with each cart item in a bordered card, thumbnail on the left.
...
<!-- wp:woocommerce/mini-cart-contents {"className":"is-mini-cart-card-list"} -->
<div class="wp-block-woocommerce-mini-cart-contents is-mini-cart-card-list"><!-- wp:woocommerce/filled-mini-cart-contents-block -->
