 ...
 * Slug: shadcn/mini-cart-summary
 * Block Types: core/template-part/mini-cart
 * Categories: shadcn, woocommerce
 * Inserter: no
 * Description: Mini-Cart drawer layout that hides the quantity stepper and remove control for a compact read-only look.
...
<!-- wp:woocommerce/mini-cart-contents {"className":"is-mini-cart-summary"} -->
<div class="wp-block-woocommerce-mini-cart-contents is-mini-cart-summary"><!-- wp:woocommerce/filled-mini-cart-contents-block -->
